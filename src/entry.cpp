...
namespace dci::module::ppn::connectivity::joining
{
    namespace
    {
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Joining>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::connectivity::joining::entry_;
}
